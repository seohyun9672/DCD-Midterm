...
<div class="object">
    <img src="imgs/objects/phone.svg" alt="phone">
</div>
<style>
    .object > img{
     position: absolute;
...
class TheObject extends HTMLElement {
    ...
    connectedCallback(){
        ...
        // }
        // this.objNum = 1;
        this.shadowRoot.querySelector(".object > img").onclick = () => {
          
          // this.changeOb();
          
        }
        document.querySelector("#object").onclick = () => this.showInfocard();
    } 
        
    changeOb(type="ob_name"){
      if(type==="ob_name"){
        this.shadowRoot.querySelector(".object > img").src = `./imgs/objects/${this.getAttribute("ob_name")}.svg`
      }
    }
